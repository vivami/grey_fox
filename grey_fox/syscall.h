...
/*
 ...
 Download xnu kernel and find the syscall numbers at 
 xnu/bsd/kern/init_sysent.c
 or xnu/bsd/sys/syscall.h -> now in Snow Leopard it's xnu/bsd/kern/syscall.h
 
 With Snow Leopard you need to execute "xnu/bsd/kern/makesyscalls.sh syscalls.master" to get the files generated
 
 This is basically a copy of the syscall.h generated for Lion 10.7.1 with useless stuff stripped out.
 
 */

#ifndef onyx_syscall_h
#define onyx_syscall_h
