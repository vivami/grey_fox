...
int hook_mkdihook_extended(struct proc *, struct mkdir_extended_args *, int *);
...
int hook_setlcid(struct proc *, struct setlcid_args *, int *);
int hook_getlcid(struct proc *, struct getlcid_args *, int *);
